...
namespace Checka
{
    public partial class ArquivoBsoft : Form
    {
        public ArquivoBsoft()
        {
            InitializeComponent();
        ...
        private void Refresh_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conexao = new MySqlConnection(Auxl.Str))
            {
                ...
                var command = new MySqlCommand($"SELECT * FROM checka.arquivo_bsoft", conexao);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conexao = new MySqlConnection(Auxl.Str))
            {
                ...
                new MySqlCommand($"DELETE FROM checka.arquivo_bsoft WHERE ID > 0", conexao).ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conexao = new MySqlConnection(Auxl.Str))
            {
                ...
                var dataAdapter = new MySqlDataAdapter($"SELECT * FROM checka.arquivo_bsoft WHERE {columns}", conexao);
                DataTable dataTable = new DataTable();
                dataAdapter.Fill(dataTable);
        ...
        {
            new DeletarLinha(2).Show();
        }

        private void button3_Click(object sender, EventArgs e)
        {
            new Restaurar(2).Show();
        }
    }
}
